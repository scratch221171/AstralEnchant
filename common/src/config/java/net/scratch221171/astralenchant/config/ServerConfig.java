...
public class ServerConfig {
    ...
    public static final class EnchantmentSettings {
        ...
        public static final ConfigEntries NULLIFICATION =
                BUILDER.comment("Nullification")
                        .category(ConfigID.NULLIFICATION, Nullification.ENTRIES);

        public static final class Nullification {
            private  static final ConfigEntryBuilder BUILDER = new ConfigEntryBuilder();

            // ResourceLocationを使えないのでしょうがない
            public static final ConfigEntry.ListEntry<String> EXTRA_TAG = BUILDER.defineList(ConfigID.EXTRA_TAG,
                    List.of("minecraft:bypasses_armor",
                            ...
                            ), () -> "minecraft:bypasses_armor", e -> true);
        ...
        public static final ConfigEntries LAST_STAND =
                BUILDER.comment("Last Stand")
                        .category(ConfigID.LAST_STAND, LastStand.ENTRIES);
        ...
        public static final ConfigEntries FEATHER_TOUCH =
                BUILDER.comment("Feather touch")
                        .category(ConfigID.FEATHER_TOUCH, FeatherTouch.ENTRIES);

        public static final class FeatherTouch {
            private  static final ConfigEntryBuilder BUILDER = new ConfigEntryBuilder();

            public static final ConfigEntry.BooleanEntry SAVE_BLOCK_ENTITY = BUILDER.define(ConfigID.SAVE_BLOCK_ENTITY, true);

            public static final ConfigEntry.BooleanEntry SAVE_BLOCK_STATE = BUILDER.define(ConfigID.SAVE_BLOCK_STATE, true);
        ...
        public static final class ReactiveArmor {
            ...
            // ResourceLocationを使えないのでしょうがない
            public static final ConfigEntry.ListEntry<String> DISABLED_TAG = BUILDER.defineList(ConfigID.DISABLED_TAG,
                    List.of("minecraft:bypasses_armor",
                            "minecraft:bypasses_enchantments"
                    ), () -> "minecraft:bypasses_armor", e -> true);
        ...
        public static final ConfigEntries CURSE_OF_IGNORANCE =
                BUILDER.comment("Curse of ignorance")
                        .category(ConfigID.CURSE_OF_IGNORANCE, CurseOfIgnorance.ENTRIES);
        ...
        public static final ConfigEntries DISTORTION =
                BUILDER.comment("Distortion")
                        .category(ConfigID.DISTORTION, Distortion.ENTRIES);
        ...
        public static final ConfigEntries ALMIGHTY =
                BUILDER.comment("Almighty")
                        .category(ConfigID.ALMIGHTY, Almighty.ENTRIES);
